...
(() => {
  ...
  const restoreBootUrl=()=>{if(!window.__NX35_HOME_BOOT__&&!location.pathname.includes('__nx35_home_boot__'))return;history.replaceState({},'',pages?`${base}/?build=44.46.0&p=%2F`:'/');delete window.__NX35_HOME_BOOT__;document.documentElement.classList.remove('nx35-home-boot')};
  ...
  const loadHome=()=>{
    ...
    script.src=`${base}/preview-v35/home-v35.js?v=44.46.0`;
