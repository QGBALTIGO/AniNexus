...
export function looksPortuguese(value = '') {
  ...
  const pt = languageHits(text, ['uma', 'que', 'para', 'com', 'seu', 'sua', 'quando', 'após', 'mundo', 'história', 'vida', 'jovem', 'escola', 'poder', 'dos', 'das', 'não', 'como', 'mas', 'por', 'em']);
  const en = languageHits(text, ['the', 'and', 'with', 'his', 'her', 'when', 'after', 'world', 'story', 'life', 'young', 'school', 'power', 'from', 'into', 'but']);
  return (/[áàâãéêíóôõúç]/i.test(text) && pt >= 1) || (pt >= 3 && pt > en * 1.35);
}
