...
(() => {
  ...
  function paint(m){
    ...
    const comments=()=>'<section class="nx22-full nx50-social-host" id="nx22EpisodeComments"><div class="nx22-panel-loading"><i></i><i></i><span>Carregando comentários…</span></div></section>';
    ...
    const panels={geral:general,impressoes:impressions,comentarios:comments,aberturas:openings,elenco:cast,franquia:franchise,recomendacoes:recommendations};
