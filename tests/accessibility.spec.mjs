...
const pageUrl = route => `${ORIGIN}?build=40.8.0&p=${encodeURIComponent(route)}`;
...
for (const route of ['/', '/animes/catalogo', '/animes/programacao', '/anime/anime-teste-101', '/comunidade', '/login', '/admin', '/quem-somos', '/termos-de-uso']) {
