export const ACTIVE_PREVIEW_DIRS=[
  ...
  'preview-v35','preview-v36','preview-v37','preview-v38','preview-v39','preview-v40','preview-v41','preview-v42'
];

export const ARCHIVED_PREVIEW_DIRS=[
