...
(() => {
  ...
  const BUILD='44.3.0';
  const DEDICATED=['/','/animes/catalogo','/animes/programacao','/animes/temporadas','/mangas','/light-novels','/noticias','/comunidade','/login','/criar-conta','/minha-conta','/meus-animes','/meus-mangas','/admin'];
