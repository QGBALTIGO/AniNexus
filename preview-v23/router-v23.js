...
(() => {
  ...
  const BUILD='44.26.0';
  const DEDICATED=['/','/animes/catalogo','/animes/programacao','/animes/temporadas','/animes/onde-assistir','/animes/dublados','/mangas','/light-novels','/noticias','/comunidade','/conquistas','/login','/criar-conta','/minha-conta','/meus-animes','/meus-mangas','/admin'];
